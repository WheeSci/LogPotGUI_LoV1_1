...
public class LogPotGUI_LoV1_1 extends PApplet {

 
///////////////////////////////////////// Imports/////////////////////////////////
 // for warning window
    // For chart classes.
 // for intergration window
...
PopupWindow warning = new PopupWindow(this,new WarningSketch());
...
public void draw() {
 ...
 pushMatrix();
 fill(0xffDEC507);
 text("Smoky Mountain",30,height-67);
 text("Scientific",36,height-53);
 popMatrix(); 
 pushMatrix();
 textFont(font2,12);
 fill(0xffDEC507);
// fill(#080606);
 text("LogPotGUI_LoV1_1",20,height-30);
 popMatrix(); 
 textFont(font2);
 //if (bool == false){
...
class WarningSketch extends EmbeddedSketch{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "LogPotGUI_LoV1_1" };
    if (passedArgs != null) {
